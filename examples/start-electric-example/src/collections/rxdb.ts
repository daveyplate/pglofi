...
const pullStream$ = new Subject<RxReplicationPullStreamItem<unknown, unknown>>()
...
todosCollection.on("subscribers:change", (event) => {
    console.log("subscribers:change", event)
})

todosCollection.on("loadingSubset:change", (event) => {
    console.log("loadingSubset:change", event)
})
